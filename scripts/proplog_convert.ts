...
namespace Proplog_convert {
// ====== module start =========

    var maxvarnr: number = 0; // used by the rename_vars_in_formula
    var printlen: number = 0; // used while printing
    var printlst: any[] = []; // used while printing
    var printarray: any[] = [];  // used while printing the truth table
...
// =========== formula and clause list printing ===============
   ...
   */
    ...
    export function parsed_print(data: any, origvars: any): any {
        var tmp;
        tmp = typeof data;
        if (!data) return "";
    ...
    function formula_print(data: any, origvars: any) {
        //var tmp;
        let res;
        printlst = [];
        printlen = 0;
    ...
    */
    ...
    function formula_print_aux(data: any, origvars: any, depth: any) {
        var tmp, nr, s, op, i;
        tmp = typeof data;
        if (!data) return;
    ...
    */
    ...
    function clauses_print(data: any, origvars: any) {
...
// =========== variable renaming ===============
   ...
   */
    ...
    export function rename_vars_in_clauses(clauses: any): any {
        let renamedvars: any = {};
        let origvars: any[] = [];
   ...
   */
    ...
    export function rename_vars_in_formula(tree: any): any {
        let  renamedvars:any = {};
        let origvars: any[] = [];
        //var res, tmp;
        maxvarnr = 0;
    ...
    */
    ...
    function rename_vars_in_formula_aux(tree: any, origvars: any, renamedvars: any) {
        var i, el, tmp;
...
// ====== converter to CNF: clause normal form =======
   ...
   */
    ...
    export function formula_to_cnf(frm: any): any {
    ...
    */
    ...
    function formula_negpush(frm: any, sign: any): any {
        var tmp, op, res, i;
        tmp = typeof frm;
        if (tmp === "number" || tmp === "string") {
            // frm is a variable
    ...
    */
    ...
    function formula_cnf_distribute(frm: any) {
        var op, res, j, k, el, tmp, simp, comp;
        tmp = typeof frm;
        if (tmp === "number" || tmp === "string") {
            // frm is a variable
            return frm;
    ...
    */
    ...
    function combinations(pre: any, terms: any) {
        var i, j, k, term;
        let res: any[];
        var tmp, c;
        tmp = [pre];
...
// ============ build the truth table ===================
    ...
    export function print_truthtable(data: any): any {
        var tmp, count, frm, syntax, origvars, res;
        if (!data) return "";
        if (typeof data[0] === "number") {
            syntax = "dpll";
            data.shift();
            tmp = rename_vars_in_clauses(data);
        } else {
            syntax = "formula";
            tmp = rename_vars_in_formula(data);
        }
        count = tmp[0];
        frm = tmp[1];
        origvars = tmp[2];
    ...
    function truthtable(frm: any, syntax: any, maxvarnr: any, origvars: any) {
    ...
    */
    ...
    function print_eval_dpll(lst: any, varvals: any) {
    ...
    */
    ...
    function add_print_pos_to_formula(data: any, origvars: any, depth: any): any {
    ...
    */
    ...
    function print_eval_formula(frm: any, varvals: any, depth: any) {
        ...
        if (op === "-") {
            ...
            for (j = 2; j < frm.length - 1; j++) {
                tmp = print_eval_formula(frm[j], varvals, depth + 1 ); //<nathalie: added last arg after typescript error>
                if (tmp === 0) res = 1;
            }
    ...
    function valfmt(s: any, depth: any) {
