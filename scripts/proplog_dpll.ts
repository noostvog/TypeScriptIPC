...
namespace Proplog_dpll {

// ====== module start =========

// trace text and the resulting model:

    var trace_flag: any = false; // false if no trace
    var trace_method: string = "text"; // ok values: text, html or console
    var trace_list: any[] = [];  // list of strings
    var origvars: any = []; // original variable names to use in trace, if available and not false
    var result_model: any[] = []; // set by solver to a resulting model: values of vars

// statistical counts:

    var unit_propagations_count: number = 0;
    var var_selections_count: number = 0;
    var units_derived_count: number = 0;
    var pure_derived_count: number = 0;
    var clauses_removed_count: number = 0;
    var max_depth_count: number = 0;

    var varactivities: any[]; // array of variable activities for preference, assigned later
...
// ====== improved dpll solver ==========
    ...
    */
    ...
    export function dpll(clauses: any, maxvarnr: any, trace: any, varnames: any): any {
    ...
    function satisfiable_at(derivedlen: any, depth: any, clauses: any, varvals: any, occvars: any, posbuckets: any, negbuckets: any, derived: any): any {
        var propres, nextvar, lit, i, satval, s;
    ...
    */
    ...
    function unit_propagate(derivedlen: any, depth: any, clauses: any, varvals: any, posbuckets: any, negbuckets: any, derived: any): any {
        clauses;
        var i, j, dlit, negdlit, lit, nr, vval, polarity, derivednext;
    ...
    */
    ...
    function next_var(clauses: any, varvals: any, occvars: any): any {
        clauses;
        occvars;
    ...
    */
    ...
    function store_model(varvals: any): any {
        var i;
        //result_model=[];
        for (i = 1; i < varvals.length; i++) {
...
// ================= preprocessing phase ========================
    ...
    */
    ...
    function maxvar_and_meta(clauses: any): any {
    ...
    */
    ...
    function simplify_clause_list(clauses: any, varvals: any, occvars: any, posbuckets: any, negbuckets: any, derived: any): any {
        occvars;
        posbuckets;
        negbuckets;
        derived;
        var clauses2, i, j, k, clause, lit, nlit, nr, sign, remove, cuts, dups, nlen, nc, unsat, s;
        clauses = clauses.sort(function (a: any, b: any) {
    ...
    */
    ...
    function count_occurrences(clauses: any, varvals: any, occvars: any, posbuckets: any, negbuckets: any, derived: any) {
        posbuckets;negbuckets;derived;
        var clauses2, i, j, clause, lit, nr, sign, remove;
        var clen, vval, oval, bonus, purevars, s, maxact;
    ...
    */
    ...
    function makebuckets(clauses: any, varvals: any, occvars: any, posbuckets: any, negbuckets: any, derived: any): any {
        derived;
        varvals; occvars;
...
// ======== optional trace printing ============
    ...
    function print_trace(depth: any, txt: any): any {
        var i, s = "";
    ...
    function clause_to_str(cl: any): string {
        var i, s = "";
    ...
    function array_to_str(cl: any): string {
        var i, s = "";
    ...
    function array_list_to_str(arr: any[]): string {
        array_list_to_str;
        var i, s = "";
    ...
    function clause_list_to_str(lst: any[]): string {
        var i, s = "[";
    ...
    function clause_list_list_to_str(lst: any[]): string {
        clause_list_list_to_str;
        var i, s = "[";
        for (i = 0; i < lst.length; i++) {
